...
// import { allProducts, fetchData} from "../../Data";
import allProducts from "../../Data_";
...
const filterReduce = (state, action) => {
  switch (action.type) {
    ...
    case "VEGETABLE":
      return {
        ...filterItemsHandler("fruits&vegies")
      };
    case "FRUIT":
      return {
        ...filterItemsHandler("Clothes")
      };
    case "NUTS":
      return {
        ...filterItemsHandler("Electronics")
      };
    case "BEANS":
      return {
        ...filterItemsHandler("Cleaning")
      };
    default:
      return state;
  }
